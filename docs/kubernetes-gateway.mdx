...
- ⚠️ The gateway Pod **must run in a namespace with access** to the services you intend to expose. If you use Network Policies or strict namespace isolation, adjust accordingly.
