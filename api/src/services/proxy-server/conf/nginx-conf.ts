...
const toNginxConf = (entriesOrObject) => {
  // Generate the conf
...
export class NginxConf {
  ...
  public addUpstreams(upstreamName: string, endpoints: string[]) {
  ...
  public addServer(server: NginxServerConf) {
  ...
  public addBlock (blockName: string, value: string[][] | string[] | string) {
